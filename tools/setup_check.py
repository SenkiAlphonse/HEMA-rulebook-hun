...
# Allow running `python tools/setup_check.py` without installing the package
...
def check_files():
    ...
    required_files = {
        ...
        "src/qa_tools/tools/parser.py": "Rule parser",
        "src/qa_tools/search_engine/search_aliases.py": "Search engine",
        "data/search/rules_index_hun.json": "Hungarian rule index",
        "data/search/rules_index_eng.json": "English rule index",
        "data/search/aliases.json": "Search aliases",
...
def main():
    ...
    if all_passed:
        ...
        print("  2. Run the app: python wsgi.py")
